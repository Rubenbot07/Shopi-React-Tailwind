  ...
  return (
    ...
    >
      ...
      >
        ...
        >
          <img
            className='h-full w-full object-contain md:w-full' src='https://fakestoreapi.com/img/81fPKd-2AYL._AC_SL1500_.jpg' alt='test-image'
          />
          <span
        ...
        <div
          className='flex flex-col justify-evenly relative bg-gray-800 pb-3 md:pt-8 md:w-3/5 h-full rounded-t-2xl rounded-b-lg text-white md:rounded-r-lg md:rounded-l-none'
        >
          <div
          ...
          <button
            className='flex items-center gap-2 text-lg text-center bg-white text-gray-800 rounded-md px-3 w-2/4 self-center font-semibold min-w-36'
          >
            <FaCartPlus />
            Add to cart
          </button>
