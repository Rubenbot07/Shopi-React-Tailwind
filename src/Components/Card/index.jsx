  ...
  return (
    <div className='bg-white cursor-pointer w-56 h-60 rounded-lg'>
      <figure className='relative mb-2 w-full h-4/5'>
        <span className='absolute bottom-0 left-0 bg-white/60 rounded-lg text-black text-xs px-3 py-0.5 m-2'>{category}</span>
        <img
      ...
      <p className='flex justify-between gap-1'>
        <span className='text-sm font-light h-4 truncate'>{title}</span>
